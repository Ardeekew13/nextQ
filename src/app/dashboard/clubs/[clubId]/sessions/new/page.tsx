...
const QUEUE_MODES: {
...
}[] = [
	{
		...
		label: "Hybrid",
		description:
			"Wait time first, then gentle catch-up for late arrivals. Best for most clubs.",
		recommended: true,
		catchUp: "limited",
	...
	},
	{
		...
		label: "Balanced",
		description:
			"Everyone finishes with the same number of games. Late arrivals are prioritised until they catch up.",
		catchUp: "full",
	...
	},
	{
		...
		label: "Smart",
		description:
			"Strict queue order by wait time. Late arrivals join the back of the queue — no catch-up.",
		catchUp: "none",
				...
				>
					...
					<Form.Item label="Queue mode" required>
									...
									>
										...
										<Text
											...
											style={{
												...
												display: "block",
												fontSize: 13,
												color: selected ? "#db2777" : undefined,
											}}
										>
											{m.description}
										</Text>
						...
						>
							<Badge
								variant={
									selectedMode.catchUp === "full"
										? "green"
										: selectedMode.catchUp === "limited"
											? "blue"
											: "gray"
								}
								style={{ flexShrink: 0 }}
