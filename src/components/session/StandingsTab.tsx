    ...
    <div style={{ display: "flex", alignItems: "flex-start", flex: 1, minHeight: 0, overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, minWidth: 0, padding: "24px 28px", overflowY: "auto", height: "100%" }}>
        ...
        <div style={{ border: "1px solid rgba(138,39,72,0.12)", borderRadius: 8, overflow: "hidden" }}>
          {/* Header */}
          <div style={{ display: "grid", gridTemplateColumns: GRID, background: "#f9f0f4", borderBottom: "2px solid rgba(225,29,116,0.18)" }}>
        ...
        <div style={{ border: "1px solid rgba(138,39,72,0.12)", borderRadius: 8, overflow: "hidden" }}>
          <div style={{ display: "grid", gridTemplateColumns: "60px 1fr 110px 110px 100px 90px", background: "#f9f0f4", borderBottom: "2px solid rgba(225,29,116,0.18)" }}>
